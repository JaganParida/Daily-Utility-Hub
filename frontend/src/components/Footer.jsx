...
import { Globe, MessageSquare, Mail, Github, Twitter } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-5 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="w-8 h-8 rounded-lg border border-[#222230] flex items-center justify-center text-[#6a6a7a] hover:bg-[#7C5CFC]/10 hover:text-white transition-colors" title="GitHub"><Github size={14} /></a>
              <a href="#" className="w-8 h-8 rounded-lg border border-[#222230] flex items-center justify-center text-[#6a6a7a] hover:bg-[#7C5CFC]/10 hover:text-white transition-colors" title="Twitter"><Twitter size={14} /></a>
