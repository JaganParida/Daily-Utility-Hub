...
import { UserPlus, Loader2, ArrowLeft, Layers, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <PageTransition className="flex-1 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <Link to="/" className="absolute top-6 left-6 md:top-10 md:left-10 flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors font-medium bg-muted/40 px-4 py-2 rounded-lg border border-border hover:bg-muted text-sm">
          <ArrowLeft size={16} />
          Back to Home
        </Link>
        ...
        <div className="mb-8 text-center flex flex-col items-center">
          ...
          <p className="text-muted-foreground text-sm font-medium">
            Join Daily Utility Hub to unlock cross-device syncing.
          </p>
        </div>
        
        {/* Flat Professional Login Card */}
        <div className="max-w-md w-full bg-card p-8 sm:p-10 rounded-2xl shadow-sm border border-border">
          ...
          <div className="flex flex-col gap-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-xl bg-background hover:bg-muted text-foreground font-semibold transition-colors disabled:opacity-50"
            >
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-card text-muted-foreground text-[10px] uppercase tracking-widest font-bold">Or register with email</span>
              </div>
            </div>
          </div>
          ...
          <form className="space-y-5 mt-4" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div>
                <label className="text-[11px] font-bold uppercase tracking-widest text-muted-foreground ml-1 mb-1.5 block">Password</label>
          ...
          <div className="mt-8 pt-6 border-t border-border flex flex-col items-center justify-center gap-4">
