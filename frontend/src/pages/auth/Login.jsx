      ...
      <PageTransition className="flex-1 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center flex flex-col items-center">
          ...
          <p className="text-muted-foreground text-sm font-medium">
            Sign in to access your utilities and workspaces.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-card text-muted-foreground text-[10px] uppercase tracking-widest font-bold">Or sign in with email</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link to="/forgot-password" className="text-[11px] font-bold text-primary hover:text-primary/80 transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <input
