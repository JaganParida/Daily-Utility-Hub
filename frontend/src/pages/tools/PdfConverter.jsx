  ...
  return (
    <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-6 md:px-8">
      <div className="mb-6 flex items-center gap-3 shrink-0">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-foreground">Advanced PDF Converter</h1>
          <p className="text-muted-foreground mt-1.5 text-sm sm:text-base">Convert PDF documents into editable Word files or high-quality PNG/JPG images.</p>
        </div>
      </div>
