  ...
  return (
    <div className="tool-page-container">
      <ToolHeader
        ...
        description="Auto-generate professional documentation from GitHub or build it manually."
        category="Student & Docs"
        categoryPath="/search"
        icon={FileText}
        iconColor="text-[#137333] bg-[#e6f4ea] border-[#ceead6]"
        badge="Professional README Builder"
        extraBadge="Shield Badges & Tables"
      />
      ...
      <div className="flex flex-col lg:flex-row gap-6 w-full items-start">
        ...
        <div className="w-full lg:w-[450px] xl:w-[550px] shrink-0 flex flex-col gap-6 lg:sticky lg:top-6 lg:h-[calc(100vh-8rem)] font-sans">
          ...
          <div className="bg-white border border-border rounded-2xl shadow-sm flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar prose prose-slate max-w-none text-slate-800 text-sm">
              <ReactMarkdown
                ...
                components={{
                  ...
                  img: ({node, ...props}) => <img className="inline-block mr-1 max-w-full rounded-xl shadow-xs" {...props} />
                }}
              >
                {markdown}
              </ReactMarkdown>
