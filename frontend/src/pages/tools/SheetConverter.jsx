...
const SheetConverter = () => {
  ...
  return (
    <div className="tool-page-container">
      <ToolHeader
        title="Spreadsheet to JSON/XML Converter"
        description="Upload CSV or Excel sheets, extract data client-side, and convert to structured code schemas instantly."
        category="Excel & Sheets Tools"
        categoryPath="/search"
        icon={Braces}
        iconColor="text-[#f29900] bg-[#fef7e0] border-[#feefc3]"
        badge="Spreadsheet Schema Converter"
        extraBadge="CSV/Excel to JSON, XML, SQL"
      />
