  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-foreground">Advanced Gradient Generator</h1>
          <p className="text-muted-foreground mt-1 text-xs md:text-sm">Create and export multi-stop CSS, SVG, and Tailwind gradients with interactive controls.</p>
        </div>
      </div>
