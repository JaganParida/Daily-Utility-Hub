  ...
  return (
    <div className="max-w-[1600px] mx-auto w-full px-2 md:px-8">
      <div className="mb-6 flex items-center gap-3 shrink-0">
        ...
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-foreground">Advanced Zip Archiver</h1>
          <p className="text-muted-foreground mt-1 text-xs md:text-sm">Compress multiple files into a single ZIP, or extract and preview contents of existing ZIPs.</p>
        </div>
      </div>
