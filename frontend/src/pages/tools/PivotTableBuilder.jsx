  ...
  return (
    <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-6 md:px-8">
      <div className="mb-6 flex items-start gap-4 shrink-0">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-foreground">Pivot Table & Chart Builder</h1>
          <p className="text-muted-foreground mt-1.5 text-sm sm:text-base">Group rows, aggregate values, compile instant pivot summaries, and visualize spreadsheet trends using custom SVG charts.</p>
        </div>
      </div>
