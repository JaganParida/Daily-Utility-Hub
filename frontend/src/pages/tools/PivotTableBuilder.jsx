...
const PivotTableBuilder = () => {
  ...
  return (
    <div className="tool-page-container">
      <ToolHeader
        title="Pivot Table & Chart Builder"
        description="Group rows, aggregate values, compile instant pivot summaries, and visualize spreadsheet trends using custom SVG charts."
        category="Excel & Sheets Tools"
        categoryPath="/search"
        icon={TrendingUp}
        iconColor="text-[#137333] bg-[#e6f4ea] border-[#ceead6]"
        badge="Pivot & Chart Builder"
        extraBadge="Interactive Aggregations & Charts"
      />
