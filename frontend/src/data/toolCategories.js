...
export const toolCategories = {
  ...
  'PDF Tools': [
    ...
    { name: 'PDF to Word Converter', description: 'Convert PDF to editable Word (.docx) with advanced OCR & layout preservation.', icon: FileText, to: '/tools/pdf-to-word', color: 'text-blue-600 bg-blue-600/10' },
    { name: 'PDF to Image Converter', description: 'Convert PDF pages into high-resolution PNG, JPG, or WEBP images.', icon: ImageIcon, to: '/tools/pdf-converter', color: 'text-rose-500 bg-rose-500/10' },
