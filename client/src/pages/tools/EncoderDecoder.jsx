  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex items-center gap-3.5">
        ...
        <div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-foreground">Symmetric Encryption Encoder / Decoder</h1>
          <p className="text-muted-foreground mt-1 text-xs md:text-sm">Encrypt plain text or decrypt ciphertext with various standards like AES, Triple DES, Rabbit, or RC4.</p>
        </div>
      </div>
