      ...
      <div className="max-w-[1600px] mx-auto w-full py-8 px-4 md:px-12 lg:px-20 xl:px-32">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl md:text-5xl font-black tracking-tight text-foreground mb-4">
              Recently <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">Used</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl font-medium">
              Pick up right where you left off. Here are the tools you've interacted with recently.
            </p>
          </div>
        ...
        {recentToolObjects.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-foreground mb-2">No tools used yet</h2>
            <p className="text-muted-foreground max-w-sm">
              Your recently accessed tools will automatically appear here as you use the application.
            </p>
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-5 relative z-10">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl transition-all duration-300 z-30 cursor-pointer
                          ${isPinned 
                            ? 'bg-indigo-500/10 text-indigo-500 hover:bg-rose-500/10 hover:text-rose-500' 
                            : 'bg-muted text-muted-foreground hover:bg-indigo-500/10 hover:text-indigo-500 opacity-0 group-hover:opacity-100'
                          }`}
                        title={isPinned ? "Remove from pinned" : "Pin to Dashboard"}
                      >
