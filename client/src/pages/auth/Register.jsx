    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="max-w-md w-full space-y-8 bg-card p-8 rounded-3xl shadow-sm border border-border">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-card text-muted-foreground text-xs uppercase tracking-wider font-bold">Or register with email</span>
            </div>
          </div>
        </div>
            ...
            {isSubmitting ? (
              ...
              <>
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <UserPlus className="h-5 w-5 text-indigo-300 group-hover:text-indigo-200 transition-colors" aria-hidden="true" />
                </span>
                Create Account
              </>
            )}
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link to="/login" className="font-bold text-foreground hover:text-indigo-500 transition-colors">
            Sign in instead
          </Link>
        </p>
      </div>
